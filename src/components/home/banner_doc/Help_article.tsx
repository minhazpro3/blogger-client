...
export default function Help_article() {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="2000" className=" group  h-[300px] sm:h-[260px] lg:h-[310px]  w-full rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1 my-4">

            <div className="bg-slate-950 shadow-base rounded-md drop-shadow-lg shadow-indigo-700 px-5 sm:px-3 md:px-5 lg:px-6 py-6 sm:py-6 md:py-6 lg:py-7    h-[300px] lg:h-[310px] md:h-[300px] sm:h-[260px] ">
