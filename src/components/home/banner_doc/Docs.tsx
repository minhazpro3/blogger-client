...
export default function Docs() {
    ...
    return (
        <div className="container mx-auto md:px-0 px-8 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 justify-items-stretch gap-6 sm:gap-7 md:gap-6 lg:gap-8 text-center md:my-16">
